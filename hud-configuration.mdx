...
<ParamField path="epilepsyMode" type="boolean" default="false">
...
<ParamField path="showMadnessBar" type="boolean" default="true">
  When enabled, renders the Madness bar on screen. Disable this if you do not use the madness mechanic or want a cleaner HUD.
</ParamField>

<ParamField path="madnessYOffset" type="int" default="55">
  Vertical offset in pixels used to position the Madness bar. Interpreted relative to the anchor point set by `madnessAnchor`. Valid range: `0`–`200`.
</ParamField>

<ParamField path="madnessAnchor" type="string" default="TOP_LEFT">
